...
class Deliant extends Module
{
    ...
    //      */
    //     if (((bool)Tools::isSubmit('submitDeliantModule')) == true) {
    //         $this->postProcess();
    //     }
    //
    ...
    //     $helper->submit_action = 'submitDeliantModule';
    ...
    //                     'name' => 'DELIANT_ACCOUNT_EMAIL',
    //                     'label' => $this->l('Email'),
    //                 ),
    //                 array(
    //                     'type' => 'password',
    //                     'name' => 'DELIANT_ACCOUNT_PASSWORD',
    ...
    // {
    //     return array(
    //         'DELIANT_LIVE_MODE' => Configuration::get('DELIANT_LIVE_MODE', true),
    //         'DELIANT_ACCOUNT_EMAIL' => Configuration::get('DELIANT_ACCOUNT_EMAIL', 'contact@prestashop.com'),
    //         'DELIANT_ACCOUNT_PASSWORD' => Configuration::get('DELIANT_ACCOUNT_PASSWORD', null),
    //     );
    // }
    //
    // /**
