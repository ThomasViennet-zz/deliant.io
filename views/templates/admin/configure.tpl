...
<div class="panel">
	<h3><i class="icon icon-tags"></i> {l s='Documentation' mod='deliant'}</h3>
	<p>
		&raquo; {l s='You can get a PDF documentation to configure this module' mod='deliant'} :
		<ul>
			<li><a href="#" target="_blank">{l s='English' mod='deliant'}</a></li>
			<li><a href="#" target="_blank">{l s='French' mod='deliant'}</a></li>
		</ul>
	</p>
</div>
